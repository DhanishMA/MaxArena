...
void AHeroController::BeginPlay()
{
    ...
    if(HasAuthority()) SwitchCharacter(0);
}
...
{   
    ...
    ServerSpawnCharacter(CharacterArray[CharacterIndex]);

    return CharacterIndex;

}

void AHeroController::ServerSpawnCharacter_Implementation(TSubclassOf<ACharacter> newCharacterClass)
{
